...
import typeBook from '../../data/typeBoook.json';

const renderDivider = () => <View style={styles.divider} />;

export default function EBookCatgScreen() {
  const navigation = useNavigation();
  const renderServiceCatg: ListRenderItem<any> = ({ item, index }) => (
    <TouchableOpacity onPress={() => navigation.navigate('EBookCatgDetailScreen')}>
